                  ...
                  <div class="a-spacing-base">
                    <div class="a-row">
                      <strong>
                        Shipping address
                        <small>
                          <router-link to="/addresses">Change</router-link>
                        </small>
                      </strong>
                    </div>
                    <div class="a-row">
                      <div class="displayAddressDiv">
                        <ul class="displayAddressUL">
                          <li>{{ currentUser.address.fullName }}</li>
                          <li>{{ currentUser.address.streetAddress }}</li>
                          <li>{{ currentUser.address.city }}</li>
                          <li>{{currentUser.address.country }}</li>
                          <li>
                            Phone:
                            <span dir="ltr">{{currentUser.address.phoneNumber }}</span>
                          </li>
                        </ul>
                      </div>
                    </div>
                      ...
                      <fieldset>
                        ...
                        <div class="a-spacing-mini wednesday">
                          <input
                            ...
                            name="order0"
                            checked="checked"
                            v-on:change="chooseshipment('normal')"
                          />
                        ...
                        <div class="a-spacing-mini tuesday">
                          <input type="radio" name="order0" v-on:change="chooseshipment('fast')" />
                          <span class="a-radio-label">
                            <span class="a-color-success">
                  ...
                  <div class="order-summary" style="font-size: 12px;">
                    <div class="row">
                      ...
                      <div
                        ...
                        :key="product._id"
                      >USD ${{ product.price * product.quantity }}</div>
                    </div>
                    <div class="row">
      ...
      <div class="a-row a-spacing-small a-spacing-top-small">
        ...
        <div class="a-color-secondary a-size-mini">
          <p class="a-color-secondary a-size-mini">
            ...
            <br />
            <br />Go to the
            <a href="#">Amazon.com homepage</a> without
...
export default {
  ...
  async created() {
    try {
      const response = await axios.post("/api/payments/shipment", {
        shipment: "normal"
      });
