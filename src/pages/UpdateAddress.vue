                  ...
                  <div class="a-spacing-top-large">
                    <span class="a-button-register">
                      <span class="a-button-inner">
                        <span class="a-button-text" @click.prevent="onUpdateAddress">Update address</span>
                      </span>
                    </span>
                  </div>
                </div>
...
export default {
  ...
  methods: {
    ...mapActions("addresses", ["fetchAddress"]),
    async onUpdateAddress() {
      try {
        ...
        await axios.patch(`/api/addresses/${this.$route.params.id}`, data);
