...
export default {
  ...
  created() {
    ...
    this.fetchProduct(productId), this.$store.dispatch("owners/fetchOwners");
    this.$store.dispatch("categories/fetchCategories");
  },
  computed: {
    ...mapState({
      owners: (state) => state.owners.items,
  ...
  methods: {
    ...
    async submitForm() {
      try {
        ...
        await axios.patch(`/api/products/${this.$route.params.id}`, formData);
