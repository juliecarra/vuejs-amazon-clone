      ...
      <div class="container-fluid desktop-nav">
        ...
        <div class="row">
            ...
            <div class="nav-global-location">
              <router-link to="/addresses" class="nav-a nav-a-2">
                ...
                <div id="glow-ingress-block">
                  ...
                  <span class="nav-line-2" id="glow-ingress-line2" v-else>France</span>
                </div>
              </router-link>
            </div>
          </div>
          <div class="col-xl-6 col-lg-5 col-md-4 col-sm-6 p-0">
            <div class="nav-fill">
              <div class="nav-shop">
                <router-link to="/history" class="nav-a nav-a-2 nav-single-row-link">
            ...
            <div class="nav-tools">
              ...
              <template v-if="currentUser">
                ...
                >
                  ...
                  <span class="nav-line-2">{{ currentUser.name }}</span>
                </router-link>
              </template>
              <template v-else>
                <router-link
              ...
              <router-link to="/orders" class="nav-a nav-a-2 nav-single-row-link">
